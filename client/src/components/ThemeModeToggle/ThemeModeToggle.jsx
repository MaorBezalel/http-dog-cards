...
export default function ThemeModeToggle() {
    const { getThemeMode, toggle } = useThemeMode('light');

    return (
        <div className="theme-mode-toggle__container">
            <input
                className="theme-mode-toggle__checkbox"
                type="checkbox"
                id="darkmode-toggle"
                checked={getThemeMode() === 'dark'}
            />
            <label
                className="theme-mode-toggle__label-container"
